<div class="menu_container">
    ...
    <div id="person">
        ...
        <!-- <a href="<?php echo 'index.php?cat=loadIMG&user=' . $_REQUEST['user']; ?>" id="camera_AVT" class="camera"></a> -->
        <div id="BGR" style="background-color: rgb(163, 163, 163);">
            <div style="background-image: url('<?php $person->loadBGR($_REQUEST['user']) ?>'); width:70%; height:100%;margin-left:15%">
                <!-- <a href="<?php echo 'index.php?cat=loadIMG&user=' . $_REQUEST['user']; ?>" id="camera_BGR" class="camera"></a> -->
            </div>
